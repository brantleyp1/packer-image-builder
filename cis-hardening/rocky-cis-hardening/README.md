# Rocky Linux CIS Hardening role

CIS based hardening role for defining a security baseline on Rocky Linux 8+. Based almost entirely on [HarryHarcourt](https://github.com/HarryHarcourt/Ansible-RHEL8-CIS-Benchmarks)'s role. 

This implementation has been converted to Rocky Linux, should be compatible with: Red Hat Enterprise Linux 8.X  and CentOS 8.X (note not tested yet). 
...
This role was developed and tested against Rocky Linux 8.0
...
If you are running Rocky Linux, then this role attempts to provide one piece of the solution to the compliance puzzle.
